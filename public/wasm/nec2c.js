async function createNec2Module(moduleArg = {}) {
  var moduleRtn;
  ...
  function findWasmBinary() {
    if (Module["locateFile"]) {
      return locateFile("nec2c.wasm");
    }
    return new URL("nec2c.wasm", import.meta.url).href;
  }
  ...
  function assignWasmExports(wasmExports) {
    _main = Module["_main"] = wasmExports["m"];
...
export default createNec2Module;
