...
/// 计算所需缓冲区大小
#[wasm_bindgen]
pub fn get_spherical_surface_buffer_sizes(
    segments_r: i32,
    segments_w: i32,
) -> i64 {
...
pub fn intersect_sphere_batch(
    ...
    let sphere = Sphere::new(
        Vec3::new(sphere_center[0] as f64, sphere_center[1] as f64, sphere_center[2] as f64),
        sphere_radius,
    );
...
mod tests {
    ...
    fn test_spherical_surface_generation() {
        ...
        // 验证第一个顶点在球面上
        let r = (vertices[0] * vertices[0] + vertices[1] * vertices[1] + vertices[2] * vertices[2]).sqrt();
