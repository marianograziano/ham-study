  ...
  useEffect(() => {
    ...
    const calculate = async () => {
      ...
      try {
        ...
        const zTip = (armLength - d) * Math.cos(armAngleRad); // Positive-V upward
...
function PositiveVAntenna({ length, angle }: { length: number, angle: number }) {
...
export default function PositiveVAntennaScene({
  ...
  const handleDownload = () => {
    if (canvasRef.current) {
      ...
      link.download = "positive-v-scene.png";
    ...
    <div className="flex flex-col gap-4">
      ...
      >
        ...
        >
          ...
          <PositiveVAntenna length={physicalLength} angle={armAngleRad} />
